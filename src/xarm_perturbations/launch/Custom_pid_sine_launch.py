...
def generate_launch_description():
    ...
    pp_arg = DeclareLaunchArgument('pp',default_value="[10.0,10.0,10.0]")
    pi_arg = DeclareLaunchArgument('pi',default_value="[0.0,0.0,0.0]")
    pd_arg = DeclareLaunchArgument('pd',default_value="[10.0,10.0,10.0]")
